...
export const SPONSORS = {
  ...
  list: [
    { name: "SPHERON",              desc: "Decentralized cloud hosting for modern web apps.",          logo: "/sponsors/SPHERON.png" },
    { name: "Balsamiq",             desc: "Wireframing tool that helps teams plan UI quickly.",        logo: "/sponsors/Balsamiq.png" },
    { name: "1Password",            desc: "A secure password manager to protect your accounts.",       logo: "/sponsors/1Password.png" },
    { name: "Major League Hacking", desc: "Official student hackathon league supporting innovation.",  logo: "/sponsors/MLH.png" },
    { name: "Axure",                desc: "UX prototyping and wireframing software for teams.",        logo: "/sponsors/Axure.png" },
    { name: "Leading Learners",     desc: "Educational resources and student support programs.",       logo: "/sponsors/LeadingLearners.png" },
    { name: "Taskade",              desc: "Collaborative task management and productivity.",           logo: "/sponsors/Taskade.png" },
    { name: "echo3D",               desc: "Cloud platform for 3D, AR, and VR content.",               logo: "/sponsors/echo3D.png" },
    { name: "Wolfram",              desc: "Advanced computation software and knowledge engine.",       logo: "/sponsors/Wolfram.png" },
    { name: "Devfolio",             desc: "India's largest community of developers & hackathons.",     logo: "/sponsors/Devfolio.png" },
    { name: "Coding Ninjas",        desc: "Online coding courses for developers and learners.",        logo: "/sponsors/CodingNinjas.png" },
    { name: "Coding Blocks",        desc: "Coding bootcamps for software development.",                logo: "/sponsors/CodingBlocks.png" },
  ],
};
